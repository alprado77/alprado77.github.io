...
![dAMP ball and stick model](/images/damp-1.gif)
...
![Three dAMPs bonded in a single DNA strand](/images/sstriamp.gif)
...
![dAMP and dTMP seen from the side](/images/at-couple-roll.gif)
...
![dAMP and dTMP seen from the top](/images/at-monocolor-from-top.gif)

**Figure 5. dAMP and dTMP, top view.**

And yes, you noticed them. What are those dashed lines? These lines symbolize the bonds that keep the two deoxynucleotides attracting to each other. These bonds, all along the DNA molecule, keep both strands of the double helix together. They are called hydrogen bonds. These bonds are strong enough to keep the two strands together, but also weak enough to unzip the double helix when needed!
...
![Single strand of DNA](/images/dna-ds-1.gif)
...
![Double strand of DNA](/images/dsdna.gif)

**Figure 8. Double strand of DNA (dsDNA)**


The molecules appearing in this post have been built using [Avogadro](https://avogadro.cc/): Hanwell, M.D., Curtis, D.E., Lonie, D.C. *et al.* Avogadro: an advanced semantic chemical editor, visualization, and analysis platform. *J Cheminform* 4**,** 17 (2012). doi: [10.1186/1758-2946-4-17](https://jcheminf.biomedcentral.com/articles/10.1186/1758-2946-4-17#citeas)

These molecules have been rendered using [UCFS ChimeraX](https://www.cgl.ucsf.edu/chimera/): Pettersen, EF, Goddard, TD, Huang, CC, et al. UCSF ChimeraX: Structure visualization for researchers, educators, and developers. *Protein Science*. 2021; 30: 70– 82. doi: [10.1002/pro.3943](https://onlinelibrary.wiley.com/doi/10.1002/pro.3943)

The videos created with UCFS ChimeraX have been converted to animated gifs using [Ezgif](https://ezgif.com/video-to-gif)
