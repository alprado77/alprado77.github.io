Title: Haplossuficiency and haploinsufficiency
...
Image_credit: Human glucose transporter I
...
Researchers classify a gene as haplosufficient (HS) or haploinsufficient (HI) after performing a lot of experiments and learning the following from them:

1. Where is the gene working (in which organs or tissues).
...
The *GLUT2* gene also encodes a glucose transporter. Nevertheless, researchers have classified this gene as  HS. *GLUT2* is active in pancreatic beta cells, hepatocytes, enterocytes, and renal tubular cells. The disease that results from the failure of *GLUT2* is known as Fanconi-Bickel syndrome [(Santer et al., 1997)](https://www.nature.com/articles/ng1197-324), but this disease only manifests when the two GLUT2 alleles fail.
